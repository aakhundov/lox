...
struct ic_env_s {
  ...
  ic_is_complete_fun_t* is_complete; // callback deciding if multiline input is complete (NULL if unset)
  void*           is_complete_arg;  // user state for the is_complete callback.
